...
const Speakers = (props) => {
      ...
      <div key={index} className="col-md-3 col-sm-4 col-xs-6 flexContainer">
        <div className="speakersList flexList">
          <div className="speakerImg">
            <Link to={speakerUrl}>
              <img src={speakerState[url].img} alt={speakerState[url].name} />
            </Link>
          </div>
          <div className="name">
          ...
          <div className="socialWrapper">
            {speakerState[url].githubLink ? (
              <div className="socialIcon">
                <a href={speakerState[url].githubLink} target="_blank" rel="noopener noreferrer">
            ...
            {speakerState[url].twitterLink ? (
              <div className="socialIcon">
                <a href={speakerState[url].twitterLink} target="_blank" rel="noopener noreferrer">
            ...
            {speakerState[url].linkedInLink ? (
              <div className="socialIcon">
                <a href={speakerState[url].linkedInLink} target="_blank" rel="noopener noreferrer">
  ...
  return (
    <div
      id="speakers"
      className={'speakersWrapper lightGrayBgColor sectionWrapper watermarkWrapper'}
    >
      <div className={'container noPadd'}>
        <div className={'sectionHeader'}>SPEAKERS</div>
        <div className={'pinkSeperateLine'}></div>
        <div className={'speakersListWrapper flexBoxWrapper'}>{speakersContainer}</div>
      </div>
