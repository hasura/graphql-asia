...
const Schedule = () => (
  <div
    id="schedule"
    className={'scheduleWrapper lightGrayBgColor sectionWrapper watermarkWrapper positionBottom'}
  >
    <div className={'container noPadd'}>
      <div className={'sectionHeader'}>SCHEDULE</div>
      <div className={'pinkSeperateLine'}></div>
      <div className={'pageDescription wd60'}>
        We will have 3 full days packed with{' '}
        <span className={'fontBold'}>workshops, lightning talks, panel discussions</span> and in
        depth technical talks about all things GraphQL, with a special focus on{' '}
        <span className={'fontBold'}>cloud-native GraphQL</span>.
      </div>
      <div className={'scheduleDetailsWrapper'}>
        <div className={'col-md-6 col-sm-6 col-xs-12 noPadd borderRight'}>
          <div className={'scheduleList'}>
            ...
            <div className={'pageDescriptionPink'}>20 FEB, 2020</div>
          </div>
        </div>
        <div className={'col-md-6 col-sm-6 col-xs-12 noPadd'}>
          <div className={'scheduleList'}>
            ...
            <div className={'pageDescriptionPink'}>21-22 FEB, 2020</div>
          </div>
        </div>
      </div>
      <div className={'buttonWrapper'}>
        <Link to="/schedule">
          <button className={'blueBtn'}>SCHEDULE</button>
        </Link>
      </div>
        ...
        <div className={'blueBgColor col-md-12 col-sm-12 col-xs-12 noPadd wd90'}>
          <div className={'graphqlWrapper wd100'}>
            <div className={'col-md-6 col-sm-7 col-xs-12 noPadd'}>
              <div className={'graphQlHeader'}>New to GraphQL?</div>
              <div className={'graphQlDescription'}>
                Get ready for the conference by getting up to speed with GraphQL.
                <br />
                <span className={'fontBold'}>Learn GraphQL in 2 hours</span> by integrating GraphQL
                APIs to an app in your favourite frontend framework.
              </div>
              <div className={'buttonWrapper'}>
