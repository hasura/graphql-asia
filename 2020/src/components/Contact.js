...
const config = {
  ...
  formUrl:
    'https://docs.google.com/forms/d/e/1FAIpQLSdfBUtkb_blWT097EGc1GFwU3xPfH6cgjebkvhoVaxcApWl5w/formResponse',
};
    ...
    return (
      <div id="speakers" className={'contactWrapper blueGradientBgColor sectionWrapper '}>
        <div className={'container noPadd'}>
          ...
          <div className={'fieldWrapper'}>
              ...
              <form name="contact-form" onSubmit={this.doSubmit}>
                ...
                <div className={'buttonWrapper'}>
                  <button className={'sendMessageBtn'}>
                    {this.state.isSending ? (
                      ...
                      <span>
                        SEND MESSAGE <img src={arrowPink} alt={'Arrow'} />
                      </span>
                    )}
                  </button>
                </div>
                {this.state.isFormInValid ? (
                  <div className={'successMessage'}>
                    <div className={'successMessageSmall'}>
                      Please enter valid inputs - All fields are mandatory.
                    </div>
                  </div>
                ) : (
                  ''
                ...
                {this.state.isFailure ? (
                  <div className={'errorMessage'}>Error... Please try again!</div>
                ) : (
                  ''
                )}
              </form>
            ...
            <div className={'col-md-6 col-sm-6 col-xs-12 noPadd'}>
              ...
              <div className={'contactDetails contactBorBottom'}>
                ...
                <div className={'contactName'}>
                  <a
                    href="https://twitter.com/graphqlasia"
                    target="_blank"
          ...
          <div className="footerBorBottom"></div>
        </div>
      </div>
    );
  }
