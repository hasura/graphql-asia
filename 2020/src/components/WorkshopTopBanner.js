        ...
        <div className={'container noPadd'}>
          <div className="detailsWrapper">
            <div className="col-md-4 col-sm-4 col-xs-12 noPadd">
              <div className="title titleTop">WORKSHOP TITLE</div>
            </div>
            <div className="col-md-8 col-sm-8 col-xs-12 noPadd">
              <div className="profileWrapper">
                <div className="profileName">{currentWorkshop.title}</div>
                <div className="socialWrapper">
                  ...
                  <div className="workshopIcon">
                    <img src={currentWorkshop.levelImg} alt={currentWorkshop.level} />
                    <span>{currentWorkshop.level}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className={'clearBoth'}>
            {currentWorkshop.workshopDescription ? (
              <div className="aboutSpeakerWrapper">
                <div className="col-md-4 col-sm-4 col-xs-12 noPadd">
                  <div className="title titleTop">WORKSHOP DESCRIPTION</div>
                </div>
                <div className="col-md-8 col-sm-8 col-xs-12 noPadd">
                  <div className="pageDescription">{currentWorkshop.workshopDescription}</div>
                </div>
              </div>
            ) : null}
            ...
            {currentWorkshop.workshopCover ? (
              <div className="aboutSpeakerWrapper">
                <div className="col-md-4 col-sm-4 col-xs-12 noPadd">
                  <div className="title titleTop">WHAT THE WORKSHOP WILL COVER</div>
                </div>
                <div className="col-md-8 col-sm-8 col-xs-12 noPadd">
                  <div className="pageDescription">
                    <ul>
            ...
            {currentWorkshop.workshopTakeaway ? (
              <div className="aboutSpeakerWrapper">
                <div className="col-md-4 col-sm-4 col-xs-12 noPadd">
                  <div className="title titleTop">TAKEAWAYS</div>
                </div>
                <div className="col-md-8 col-sm-8 col-xs-12 noPadd">
                  <div className="pageDescription">{currentWorkshop.workshopTakeaway}</div>
                </div>
              </div>
            ) : null}
            {currentWorkshop.preRequisites ? (
              <div className="aboutSpeakerWrapper">
                <div className="col-md-4 col-sm-4 col-xs-12 noPadd">
                  <div className="title titleTop">Pre-requisites</div>
                </div>
                <div className="col-md-8 col-sm-8 col-xs-12 noPadd">
                  <div className="pageDescription">{currentWorkshop.preRequisites}</div>
                </div>
              </div>
            ) : null}
            {currentWorkshop.workshopIdeal ? (
              <div className="aboutSpeakerWrapper">
                <div className="col-md-4 col-sm-4 col-xs-12 noPadd">
                  <div className="title titleTop">Ideal audience for this workshop</div>
                </div>
                <div className="col-md-8 col-sm-8 col-xs-12 noPadd">
                  <div className="pageDescription">
                    <ul>
            ...
            <div className="aboutSpeakerWrapper">
              <div className="col-md-4 col-sm-4 col-xs-12 noPadd">
                <div className="title titleTop">SPEAKER</div>
              </div>
              {currentWorkshop.multipleSpeakers ? (
                ...
                <div className="col-md-8 col-sm-8 col-xs-12 noPadd">
                  <div className="speakersProfile">
                    ...
                    <div className="profile">
                      <div className="name">{currentWorkshop.name}</div>
                      <div className="designation">{currentWorkshop.designation}</div>
                      <div className="organization">{currentWorkshop.org}</div>
                    </div>
                  </div>
                </div>
              )}
