        ...
        <nav className="navbar navbar-default navBarDefault">
          <div className="container">
            <div className="navbar-header navBarHeader">
              <Link className="navbar-brand navBarBrand" to="/">
            ...
            >
              <ul className="nav navbar-nav navbar-right navBarRight">
                <li className={'navBarList'}>
                  <button onClick={scrollToView} srollid="/#overview">
                    OVERVIEW
                  </button>
                </li>
                <li className={'navBarList'}>
                  <button onClick={scrollToView} srollid="/#speakers">
                    SPEAKERS
                  </button>
                </li>
                <li className={'navBarList'}>
                ...
                <li className={'navBarList'}>
                  <button onClick={scrollToView} srollid="/#workshops">
                    WORKSHOPS
                  </button>
                </li>
                <li className={'navBarList'}>
                  <button onClick={scrollToView} srollid="/#sponsors">
                    SPONSORS
                  </button>
                </li>
                <li className={'navBarList'}>
                  <button onClick={scrollToView} srollid="/#ticket">
                    TICKETS
                  </button>
                </li>
              </ul>
